...
ProjJulyTemp_00_05 = [[ 20, 20, 21, 20, 20, 20, 20, 20, 20 ], [ 19, 18, 20, 18, 19, 18, 19, 18, 18 ],   # 2000-2001.
                      [ 18, 18, 19, 18, 19, 18, 18, 18, 18 ], [ 20, 20, 21, 20, 20, 20, 20, 20, 20 ],   # 2002-2003.
                      [ 20, 20, 21, 20, 21, 20, 20, 20, 20 ], [ 20, 20, 21, 20, 20, 20, 20, 20, 20 ]]   # 2004-2005.

# A list of lists, with each list representing a year (06_11) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_06_11 = [[ 20, 20, 20, 20, 20, 20, 20, 19, 20 ], [ 20, 19, 19, 19, 19, 19, 19, 19, 19 ],   # 2006-2007.
                      [ 19, 19, 20, 19, 19, 19, 19, 19, 20 ], [ 21, 21, 21, 21, 21, 21, 21, 21, 21 ],   # 2008-2009.
                      [ 21, 20, 21, 20, 21, 20, 20, 20, 20 ], [ 22, 22, 23, 22, 22, 22, 22, 22, 22 ]]   # 2010-2011.

# A list of lists, with each list representing a year (12_17) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_12_17 = [[ 21, 21, 22, 21, 21, 21, 21, 21, 21 ], [ 20, 20, 21, 20, 21, 20, 20, 20, 20 ],   # 2012-2013.
                      [ 20, 20, 21, 20, 20, 20, 20, 20, 20 ], [ 22, 21, 22, 21, 22, 21, 22, 22, 21 ],   # 2014-2015.
                      [ 20, 21, 21, 20, 21, 20, 20, 20, 20 ], [ 19, 19, 20, 18, 19, 19, 19, 19, 18 ]]   # 2016-2017.

# A list of lists, with each list representing a year (18_23) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_18_23 = [[ 19, 19, 20, 19, 20, 19, 19, 19, 19 ], [ 22, 23, 23, 22, 23, 22, 22, 22, 22 ],   # 2018-2019.
                      [ 22, 22, 23, 22, 23, 22, 22, 22, 22 ], [ 21, 20, 21, 20, 21, 20, 21, 20, 21 ],   # 2020-2021.
                      [ 21, 21, 22, 21, 21, 21, 21, 21, 21 ], [ 20, 20, 21, 20, 20, 20, 20, 20, 20 ]]   # 2022-2023.

# A list of lists, with each list representing a year (24_29) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_24_29 = [[ 22, 21, 22, 21, 22, 21, 21, 21, 21 ], [ 23, 22, 23, 22, 23, 22, 23, 23, 22 ],   # 2024-2025.
                      [ 19, 19, 20, 19, 19, 19, 19, 19, 19 ], [ 20, 20, 21, 20, 20, 20, 20, 20, 20 ],   # 2026-2027.
                      [ 19, 19, 21, 19, 20, 19, 19, 19, 19 ], [ 22, 22, 23, 22, 22, 22, 22, 22, 22 ]]   # 2028-2029.

# A list of lists, with each list representing a year (30_35) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_30_35 = [[ 20, 20, 20, 20, 20, 20, 20, 20, 20 ], [ 20, 20, 21, 20, 21, 20, 20, 20, 21 ],   # 2030-2031.
                      [ 21, 21, 21, 21, 21, 21, 21, 21, 20 ], [ 21, 21, 21, 20, 21, 20, 20, 21, 20 ],   # 2032-2033.
                      [ 20, 19, 20, 19, 19, 19, 19, 19, 20 ], [ 21, 21, 21, 21, 21, 21, 21, 20, 21 ]]   # 2034-2035.

# A list of lists, with each list representing a year (36_41) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_36_41 = [[ 21, 21, 22, 21, 22, 21, 21, 21, 21 ], [ 21, 20, 21, 20, 20, 20, 20, 20, 20 ],   # 2036-2037.
                      [ 19, 19, 20, 19, 20, 19, 19, 19, 19 ], [ 22, 22, 23, 22, 23, 22, 22, 22, 21 ],   # 2038-2039.
                      [ 21, 21, 22, 21, 22, 21, 21, 21, 21 ], [ 20, 20, 21, 20, 20, 20, 20, 19, 20 ]]   # 2040-2041.

# A list of lists, with each list representing a year (42_47) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_42_47 = [[ 21, 21, 22, 21, 21, 21, 21, 21, 21 ], [ 23, 23, 23, 23, 23, 23, 23, 23, 22 ],   # 2042-2043.
                      [ 21, 21, 22, 21, 22, 21, 21, 21, 21 ], [ 21, 21, 22, 21, 21, 21, 21, 21, 21 ],   # 2044-2045.
                      [ 19, 18, 19, 18, 19, 18, 18, 18, 18 ], [ 23, 23, 24, 23, 24, 23, 23, 23, 22 ]]   # 2046-2047.

# A list of lists, with each list representing a year (48_53) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_48_53 = [[ 20, 20, 21, 20, 21, 20, 20, 20, 20 ], [ 20, 20, 20, 20, 20, 20, 20, 20, 20 ],   # 2048-2049.
                      [ 22, 22, 23, 22, 23, 22, 22, 22, 22 ], [ 21, 22, 22, 22, 22, 21, 21, 21, 22 ],   # 2050-2051.
                      [ 20, 20, 20, 19, 20, 19, 19, 19, 19 ], [ 24, 24, 25, 24, 25, 24, 24, 24, 24 ]]   # 2052-2053.

# A list of lists, with each list representing a year (54_59) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_54_59 = [[ 21, 21, 21, 20, 21, 20, 21, 21, 20 ], [ 21, 21, 22, 21, 22, 21, 21, 21, 21 ],   # 2054-2055.
                      [ 19, 19, 20, 19, 20, 19, 19, 19, 19 ], [ 20, 20, 20, 20, 20, 20, 20, 20, 20 ],   # 2056-2057.
                      [ 21, 20, 22, 20, 21, 20, 21, 20, 20 ], [ 20, 20, 20, 19, 20, 20, 20, 20, 19 ]]   # 2058-2059.

# A list of lists, with each list representing a year (60_65) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_60_65 = [[ 21, 21, 22, 21, 21, 21, 21, 21, 21 ], [ 20, 20, 21, 19, 21, 20, 20, 20, 19 ],   # 2060-2061.
                      [ 22, 22, 22, 22, 22, 22, 22, 22, 22 ], [ 23, 23, 24, 23, 24, 23, 24, 23, 23 ],   # 2062-2063.
                      [ 22, 22, 23, 22, 23, 22, 22, 22, 21 ], [ 21, 21, 22, 21, 21, 21, 21, 21, 21 ]]   # 2064-2065.

# A list of lists, with each list representing a year (68-70) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_66_70 = [[ 20, 20, 21, 20, 21, 20, 20, 20, 20 ], [ 21, 21, 21, 21, 21, 21, 21, 21, 21 ],   # 2066-2067.
                      [ 20, 20, 21, 20, 21, 20, 20, 20, 20 ], [ 21, 20, 21, 20, 21, 20, 20, 20, 20 ],   # 2068-2069.
                      [ 22, 22, 23, 22, 22, 22, 22, 22, 22 ]]                                           # 2070.
...
Species = [ 'abiebals', 'acerrubr', 'acersacc', 'betualle', 'betupapy', 'carycord', 'fagugran',
            'fraxamer', 'fraxnigr', 'fraxpenn', 'piceglau', 'picemari', 'pinubank', 'pinuresi',
            'pinustro', 'pinusylv', 'popubals', 'popugran', 'poputrem', 'prunsero', 'queralba',
            'querelli', 'quermacr', 'querrubr', 'quervelu', 'thujocci', 'tiliamer', 'tsugcana',
            'ulmuamer', 'caryovat', 'castdent', 'quercocc', 'querfalc' ]

# A list of 13 possible July temperature values (16-29). The range aligns with the corresponding range of
...
ProbEstGauss = [ [ gauss( 0.01371,   0.1012), gauss( 0.01095,  0.08264), gauss(0.007376,  0.06373), # 1. abiebals (tsugcana).
                 ...
                 [ gauss(  0.6533,   0.1699), gauss(  0.6209,   0.1822), gauss(  0.5889,   0.1937), # 7. fagugran.
                 ...
                 [ gauss(  0.9764,  0.03404), gauss(  0.9734,  0.03808), gauss(  0.9704,  0.04229), # 8. fraxamer.
                 ...
                 [ gauss(  0.4991,	 0.3822), gauss(  0.4802,	0.3781), gauss(  0.4613,   0.3743), # 9. fraxnigr (FRAXINUSsp).
                 ...
                 [ gauss(  0.4991,	 0.3822), gauss(  0.4802,	0.3781), gauss(  0.4613,   0.3743), # 10. fraxpenn (FRAXINUSsp).
                   gauss(  0.4445,	 0.3707), gauss(  0.4294,   0.3671), gauss(  0.4162,   0.3641),
                   gauss(   0.404,   0.3625), gauss(  0.3914,   0.3608), gauss(  0.3781,   0.3586),
                   gauss(  0.3647,   0.3554), gauss(  0.3511,   0.3515), gauss(  0.3373,   0.3464),
                   gauss(  0.3237,	 0.3407), gauss(  0.3105,	0.3351) ],
                 [ gauss(  0.3218,  0.07202), gauss(  0.2791,  0.06999), gauss(  0.2401,  0.06706), # 11. piceglau (PICEAsp).
                 ...
                 [ gauss(  0.3218,  0.07202), gauss(  0.2791,  0.06999), gauss(  0.2401,  0.06706), # 12. picemari (PICEAsp).
                   gauss(   0.205,  0.06339), gauss(  0.1737,  0.05916), gauss(  0.1461,  0.05453),
                   gauss(   0.122,  0.04968), gauss(  0.1011,  0.04476), gauss( 0.08326,   0.0399),
                   gauss( 0.06808,  0.03521), gauss(  0.0553,  0.03077), gauss( 0.04463,  0.02663),
                   gauss( 0.03579,  0.02285), gauss( 0.02851,  0.01943) ],
                 [ gauss(  0.5642,  0.06676), gauss(  0.5244,  0.07091), gauss(  0.4852,  0.07467), # 13. pinubank (PINUSsp).
                 ...
                 [ gauss(  0.5642,  0.06676), gauss(  0.5244,  0.07091), gauss(  0.4852,  0.07467), # 14. pinuresi (PINUSsp).
                   gauss(  0.4472,  0.07799), gauss(  0.4104,  0.08088), gauss(  0.3751,  0.08333),
                   gauss(  0.3415,  0.08537), gauss(  0.3097,    0.087), gauss(  0.2798,  0.08824),
                   gauss(  0.2519,  0.08914), gauss(  0.2259,  0.08971), gauss(  0.2019,  0.08998),
                   gauss(  0.1798,     0.09), gauss(  0.1597,  0.08978) ],
                 [ gauss(  0.5642,  0.06676), gauss(  0.5244,  0.07091), gauss(  0.4852,  0.07467), # 15. pinustro (PINUSsp).
                   gauss(  0.4472,  0.07799), gauss(  0.4104,  0.08088), gauss(  0.3751,  0.08333),
                   gauss(  0.3415,  0.08537), gauss(  0.3097,    0.087), gauss(  0.2798,  0.08824),
                   gauss(  0.2519,  0.08914), gauss(  0.2259,  0.08971), gauss(  0.2019,  0.08998),
                   gauss(  0.1798,     0.09), gauss(  0.1597,  0.08978) ],
                 [ gauss(  0.5642,  0.06676), gauss(  0.5244,  0.07091), gauss(  0.4852,  0.07467), # 16. pinusylv (PINUSsp).
                   gauss(  0.4472,  0.07799), gauss(  0.4104,  0.08088), gauss(  0.3751,  0.08333),
                   gauss(  0.3415,  0.08537), gauss(  0.3097,    0.087), gauss(  0.2798,  0.08824),
                   gauss(  0.2519,  0.08914), gauss(  0.2259,  0.08971), gauss(  0.2019,  0.08998),
                   gauss(  0.1798,     0.09), gauss(  0.1597,  0.08978) ],
                 [ gauss( 0.08235,  0.07297), gauss( 0.06367,  0.05804), gauss( 0.04862,   0.0456), # 17. popubals (POPULUSsp).
                 ...
                 [ gauss( 0.08235,  0.07297), gauss( 0.06367,  0.05804), gauss( 0.04862,   0.0456), # 18. popugran (POPULUSsp).
                   gauss( 0.03665,   0.0354), gauss( 0.02727,  0.02717), gauss( 0.02003,  0.02063),
                   gauss( 0.01451,  0.01552), gauss( 0.01038,  0.01157), gauss(0.007329, 0.008563),
                   gauss(0.005106, 0.006297), gauss(0.003511, 0.004607), gauss(0.002382, 0.003356),
                   gauss(0.001596, 0.002435), gauss(0.001056,  0.00176) ],
                 [ gauss(  0.5642,  0.06676), gauss(  0.5244,  0.07091), gauss(  0.4852,  0.07467), # 19. poputrem (POPULUSsp).
                   gauss(  0.4472,  0.07799), gauss(  0.4104,  0.08088), gauss(  0.3751,  0.08333),
                   gauss(  0.3415,  0.08537), gauss(  0.3097,    0.087), gauss(  0.2798,  0.08824),
                   gauss(  0.2519,  0.08914), gauss(  0.2259,  0.08971), gauss(  0.2019,  0.08998),
                   gauss(  0.1798,     0.09), gauss(  0.1597,  0.08978) ],
                 [ gauss(  0.3844,   0.1422), gauss(  0.3438,   0.1363), gauss(  0.3058,     0.13), # 20. prunsero.
                 ...
                 [ gauss(  0.6696,   0.1427), gauss(  0.6378,   0.1535), gauss(  0.6063,   0.1638), # 21. queralba.
                 ...
                 [ gauss(  0.6696,   0.1427), gauss(  0.6378,   0.1535), gauss(  0.6063,   0.1638), # 22. querelli (queralba).
                   gauss(  0.5752,   0.1734), gauss(  0.5446,   0.1823), gauss(  0.5148,   0.1905),
                   gauss(  0.4859,    0.198), gauss(   0.458,   0.2048), gauss(  0.4311,   0.2109),
                   gauss(  0.4054,   0.2164), gauss(  0.3809,   0.2214), gauss(  0.3576,   0.2257),
                   gauss(  0.3356,   0.2296), gauss(  0.3148,   0.2329) ],
                 [ gauss(  0.9847,  0.05004), gauss(  0.9828,  0.05593), gauss(  0.9809,  0.06198), # 23. quermacr (quervelu).
                 ...
                 [ gauss(  0.5188,   0.1025), gauss(  0.4777,   0.1063), gauss(  0.4381,    0.109), # 24. querrubr.
                 ...
                 [ gauss(  0.9847,  0.05004), gauss(  0.9828,  0.05593), gauss(  0.9809,  0.06198), # 25. quervelu.
                   gauss(  0.9789,  0.06815), gauss(  0.9768,  0.07442), gauss(  0.9747,  0.08076),
                   gauss(  0.9726,  0.08715), gauss(  0.9704,  0.09356), gauss(  0.9683,  0.09996),
                   gauss(  0.9661,   0.1063), gauss(  0.9639,   0.1127), gauss(  0.9616,   0.1189),
                   gauss(  0.9594,   0.1251), gauss(  0.9573,   0.1312) ],
                 [ gauss(  0.1526,   0.2397), gauss(   0.119,   0.1863), gauss( 0.09313,   0.1504), # 26. thujocci.
                 ...
                 [  gauss(  0.4167,  0.05293), gauss(  0.3726,  0.05331), gauss(  0.3311,  0.05298), # 27. tiliamer (acersacc).
                   gauss(  0.2923,  0.05202), gauss(  0.2564,   0.0505), gauss(  0.2235,   0.0485),
                   gauss(  0.1935,  0.04612), gauss(  0.1666,  0.04345), gauss(  0.1425,  0.04058),
                   gauss(  0.1212,  0.03759), gauss(  0.1024,  0.03454), gauss( 0.08606,  0.03152),
                   gauss( 0.07188,  0.02856), gauss( 0.05969,  0.02571) ],
                 [ gauss( 0.01371,   0.1012), gauss( 0.01095,  0.08264), gauss(0.007376,  0.06373), # 28. tsugcana.
                   gauss( 0.00645,   0.0618), gauss( 0.00609,   0.0659), gauss(0.005025,  0.05885),
                   gauss(0.004687,  0.05671), gauss(0.004682,  0.05248), gauss(0.005329,  0.05516),
                   gauss(0.006574,  0.06729), gauss(0.006949,  0.07304), gauss(0.006716,  0.07203),
                   gauss(0.005637,  0.06427), gauss(0.005442,  0.06253) ],
                 [ gauss(  0.1469,  0.05086), gauss(  0.1131,  0.04045), gauss( 0.08576,   0.0322), # 29. ulmuamer.
                 ...
                 [ gauss(   0.974,  0.05154), gauss(  0.9708,  0.05723), gauss(  0.9676,  0.06305), # 30. caryovat (CARYAsp).
                   gauss(  0.9643,  0.06898), gauss(  0.9608,  0.07499), gauss(  0.9572,  0.08106),
                   gauss(  0.9535,  0.08716), gauss(  0.9498,  0.09328), gauss(  0.9459,  0.09939),
                   gauss(   0.942,   0.1055), gauss(   0.938,   0.1115), gauss(   0.934,   0.1175),
                   gauss(  0.9299,   0.1234), gauss(  0.9257,   0.1292) ],
                 [ gauss(  0.5188,   0.1025), gauss(  0.4777,   0.1063), gauss(  0.4381,    0.109), # 31. castdent (querrubr).
                   gauss(     0.4,   0.1107), gauss(  0.3637,   0.1113), gauss(  0.3294,   0.1109),
                   gauss(  0.2972,   0.1097), gauss(  0.2672,   0.1076), gauss(  0.2393,   0.1048),
                   gauss(  0.2136,   0.1014), gauss(    0.19,  0.09751), gauss(  0.1685,  0.09321),
                   gauss(   0.149,  0.08862), gauss(  0.1313,  0.08383) ],
                 [ gauss(  0.9847,  0.05004), gauss(  0.9828,  0.05593), gauss(  0.9809,  0.06198), # 32. quercocc (quervelu).
                   gauss(  0.9789,  0.06815), gauss(  0.9768,  0.07442), gauss(  0.9747,  0.08076),
                   gauss(  0.9726,  0.08715), gauss(  0.9704,  0.09356), gauss(  0.9683,  0.09996),
                   gauss(  0.9661,   0.1063), gauss(  0.9639,   0.1127), gauss(  0.9616,   0.1189),
                   gauss(  0.9594,   0.1251), gauss(  0.9573,   0.1312) ],
                 [ gauss(  0.9847,  0.05004), gauss(  0.9828,  0.05593), gauss(  0.9809,  0.06198), # 33. querfalc (quervelu).
                   gauss(  0.9789,  0.06815), gauss(  0.9768,  0.07442), gauss(  0.9747,  0.08076),
                   gauss(  0.9726,  0.08715), gauss(  0.9704,  0.09356), gauss(  0.9683,  0.09996),
                   gauss(  0.9661,   0.1063), gauss(  0.9639,   0.1127), gauss(  0.9616,   0.1189),
                   gauss(  0.9594,   0.1251), gauss(  0.9573,   0.1312) ] ]
...
with open('output_ProbEst_pcm_b1.csv', 'w') as f:
...
# Write the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_00_05.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_06_11.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_12_17.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_18_23.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_24_29.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_30_35.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_36_41.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_42_47.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_48_53.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_54_59.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_60_65.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_pcm_b1_66_70.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
