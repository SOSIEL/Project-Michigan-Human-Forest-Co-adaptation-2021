...
ProjJulyTemp_00_05 = [[ 21, 21, 21, 20, 21, 20, 21, 20, 20 ], [ 16, 16, 17, 16, 18, 16, 16, 16, 16 ],   # 2000-2001.
                      [ 20, 20, 21, 19, 20, 19, 20, 19, 20 ], [ 19, 19, 20, 19, 20, 19, 20, 19, 19 ],   # 2002-2003.
                      [ 27, 19, 19, 19, 18, 19, 19, 18, 18 ], [ 21, 21, 22, 20, 22, 20, 21, 22, 20 ]]   # 2004-2005.

# A list of lists, with each list representing a year (06_11) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_06_11 = [[ 20, 20, 21, 20, 20, 19, 20, 19, 20 ], [ 23, 23, 24, 22, 23, 22, 23, 22, 22 ],   # 2006-2007.
                      [ 20, 20, 21, 20, 20, 20, 20, 20, 20 ], [ 19, 19, 20, 19, 19, 19, 19, 19, 19 ],   # 2008-2009.
                      [ 17, 17, 17, 17, 17, 17, 17, 18, 18 ], [ 20, 20, 20, 20, 20, 19, 19, 20, 20 ]]   # 2010-2011.

# A list of lists, with each list representing a year (12_17) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_12_17 = [[ 19, 18, 20, 18, 19, 18, 18, 19, 18 ], [ 19, 19, 19, 20, 19, 19, 18, 18, 19 ],   # 2012-2013.
                      [ 19, 19, 20, 19, 20, 19, 20, 19, 19 ], [ 19, 19, 20, 19, 20, 19, 20, 19, 19 ],   # 2014-2015.
                      [ 18, 18, 18, 17, 19, 17, 18, 18, 18 ], [ 20, 19, 20, 20, 20, 20, 20, 19, 19 ]]   # 2016-2017.

# A list of lists, with each list representing a year (18_23) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_18_23 = [[ 20, 20, 21, 19, 21, 19, 20, 20, 20 ], [ 20, 19, 21, 19, 20, 19, 19, 20, 19 ],   # 2018-2019.
                      [ 21, 20, 22, 20, 21, 20, 20, 21, 21 ], [ 20, 20, 21, 20, 20, 20, 20, 20, 20 ],   # 2020-2021.
                      [ 19, 19, 20, 18, 19, 19, 18, 19, 18 ], [ 21, 21, 22, 20, 22, 20, 21, 22, 20 ]]   # 2022-2023.

# A list of lists, with each list representing a year (24_29) and each list element the projected July temperature
# in one of the nine ecoregions. 
ProjJulyTemp_24_29 = [[ 22, 20, 22, 19, 21, 20, 21, 22, 20 ], [ 21, 21, 22, 20, 22, 20, 21, 22, 20 ],   # 2024-2025.
                      [ 20, 20, 21, 20, 20, 20, 20, 20, 20 ], [ 20, 20, 20, 19, 20, 19, 19, 19, 19 ],   # 2026-2027.
                      [ 18, 18, 18, 17, 19, 17, 18, 18, 18 ], [ 20, 20, 21, 19, 20, 19, 20, 19, 20 ]]   # 2028-2029.

# A list of lists, with each list representing a year (30_35) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_30_35 = [[ 21, 21, 21, 20, 21, 20, 21, 21, 21 ], [ 20, 20, 21, 19, 21, 19, 20, 20, 20 ],   # 2030-2031.
                      [ 19, 19, 20, 20, 20, 19, 19, 20, 19 ], [ 19, 18, 20, 18, 19, 18, 18, 19, 18 ],   # 2032-2033.
                      [ 21, 20, 21, 19, 21, 20, 21, 20, 20 ], [ 20, 20, 21, 19, 21, 19, 20, 20, 20 ]]   # 2034-2035.

# A list of lists, with each list representing a year (36_41) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_36_41 = [[ 20, 20, 21, 20, 20, 20, 20, 20, 20 ], [ 20, 19, 21, 19, 20, 19, 19, 20, 19 ],   # 2036-2037.
                      [ 18, 18, 19, 18, 19, 18, 19, 18, 18 ], [ 19, 19, 20, 19, 19, 19, 19, 19, 19 ],   # 2038-2039.
                      [ 19, 19, 20, 18, 19, 18, 19, 19, 19 ], [ 23, 23, 24, 22, 23, 22, 23, 22, 22 ]]   # 2040-2041.

# A list of lists, with each list representing a year (42_47) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_42_47 = [[ 27, 20, 20, 20, 19, 20, 19, 20, 19 ], [ 20, 20, 21, 20, 21, 20, 20, 21, 20 ],   # 2042-2043.
                      [ 20, 20, 21, 19, 20, 19, 20, 19, 20 ], [ 19, 19, 20, 19, 20, 19, 20, 19, 19 ],   # 2044-2045.
                      [ 21, 20, 21, 19, 21, 20, 21, 20, 20 ], [ 19, 19, 20, 18, 19, 19, 18, 19, 18 ]]   # 2046-2047.

# A list of lists, with each list representing a year (48_53) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_48_53 = [[ 19, 19, 20, 19, 19, 19, 19, 19, 19 ], [ 21, 21, 22, 20, 22, 20, 21, 22, 20 ],   # 2048-2049.
                      [ 19, 19, 20, 19, 19, 19, 19, 19, 19 ], [ 21, 22, 21, 22, 21, 22, 22, 21, 21 ],   # 2050-2051.
                      [ 22, 23, 24, 23, 23, 22, 22, 23, 23 ], [ 20, 19, 20, 19, 20, 19, 20, 20, 19 ]]   # 2052-2053.

# A list of lists, with each list representing a year (54_59) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_54_59 = [[ 19, 18, 20, 18, 19, 18, 18, 19, 18 ], [ 19, 19, 19, 20, 19, 19, 18, 18, 19 ],   # 2054-2055.
                      [ 23, 23, 24, 22, 23, 22, 23, 22, 22 ], [ 20, 20, 20, 20, 20, 20, 20, 20, 20 ],   # 2056-2057.
                      [ 20, 20, 21, 20, 20, 20, 20, 20, 20 ], [ 20, 20, 21, 20, 21, 20, 20, 21, 20 ]]   # 2058-2059.

# A list of lists, with each list representing a year (60_65) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_60_65 = [[ 21, 21, 21, 20, 21, 20, 21, 21, 21 ], [ 21, 22, 21, 22, 21, 22, 22, 21, 21 ],   # 2060-2061.
                      [ 20, 20, 21, 20, 20, 19, 20, 19, 20 ], [ 26, 19, 20, 19, 20, 19, 19, 19, 19 ],   # 2062-2063.
                      [ 19, 19, 20, 19, 19, 19, 19, 19, 19 ], [ 28, 22, 21, 22, 22, 22, 21, 21, 21 ]]   # 2064-2065.

# A list of lists, with each list representing a year (66_70) and each list element the projected July temperature
# in one of the nine ecoregions.
ProjJulyTemp_66_70 = [[ 20, 20, 21, 19, 21, 19, 20, 20, 20 ], [ 18, 18, 19, 18, 19, 18, 19, 18, 18 ],    # 2066-2067.
                      [ 20, 19, 20, 19, 20, 19, 20, 20, 19 ], [ 16, 16, 17, 16, 18, 16, 16, 16, 16 ],   # 2068-2069.
                      [ 19, 19, 20, 20, 20, 19, 19, 20, 19 ]]                                           # 2070.
...
with open('output_ProbEst_curr_cli.csv', 'w') as f:
...
# Write the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_00_05.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_06_11.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_12_17.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_18_23.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_24_29.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_30_35.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_36_41.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_42_47.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_48_53.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_54_59.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_60_65.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
...
# The code writes the annual probability of establishment projections into a csv file, called ProjProbEst.
                    with open('output_ProjProbEst_curr_cli_66_70.csv', 'w') as f:
                        wr = csv.writer(f, lineterminator = '\n')
